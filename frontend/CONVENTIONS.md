...
- **The record table has a client-side filter** (name/type/content, no pagination — homelab zones are hundreds of records at most) and a **copy button** on every record value.
